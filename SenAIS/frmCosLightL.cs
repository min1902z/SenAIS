...
namespace SenAIS
{
    public partial class frmCosLightL : Form
    {
        ...
        public frmCosLightL(Form parent, OPCItem opcItemT99)
        {
            InitializeComponent();
        ...
        private void btnPre_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                opcItemT99.Write(9); // Giá trị cho form chờ hoặc giá trị tương ứng
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                opcItemT99.Write(11); // Giá trị cho form tiếp theo hoặc giá trị tương ứng
