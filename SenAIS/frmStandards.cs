        ...
        private void LoadStandardsData()
        {
            try
            {
                ...
                if (vehicleStandardsTable != null && vehicleStandardsTable.Rows.Count != 0)
                {
                    ...
                    dgStandards.Columns["MinDiffHoriLeftHB"].HeaderText = "Chênh lệch Trái/Phải đèn Pha trái tối thiểu";
                    dgStandards.Columns["MaxDiffHoriLeftHB"].HeaderText = "Chênh lệch Trái/Phải đèn Pha trái tối đa";
                    dgStandards.Columns["MinDiffHoriHB"].HeaderText = "Chênh lệch Trái/Phải đèn Pha tối thiểu";
                    dgStandards.Columns["MaxDiffHoriHB"].HeaderText = "Chênh lệch Trái/Phải đèn Pha tối đa";
                    dgStandards.Columns["MinDiffVertiHB"].HeaderText = "Chênh lệch Trên/Dưới đèn Pha tối thiểu";
                    dgStandards.Columns["MaxDiffVertiHB"].HeaderText = "Chênh lệch Trên/Dưới đèn Pha tối đa";
                    dgStandards.Columns["MinDiffHoriLB"].HeaderText = "Chênh lệch Trái/Phải đèn Cốt tối thiểu";
                    dgStandards.Columns["MaxDiffHoriLB"].HeaderText = "Chênh lệch Trái/Phải đèn Cốt tối đa";
                    dgStandards.Columns["MinDiffVertiLB"].HeaderText = "Chênh lệch Trên/Dưới đèn Cốt tối thiểu";
                    dgStandards.Columns["MaxDiffVertiLB"].HeaderText = "Chênh lệch Trên/Dưới đèn Cốt tối đa";
                    ...
                    dgStandards.Columns["MinDiffVertiFL"].HeaderText = "Chênh lệch Trên/Dưới đèn Sương mù tối thiểu";
                    dgStandards.Columns["MaxDiffVertiFL"].HeaderText = "Chênh lệch Trên/Dưới đèn Sương mù tối đa";
                    dgStandards.Columns["MinDiffHoriFL"].HeaderText = "Chênh lệch Trái/Phải đèn Sương mù tối thiểu";
                    dgStandards.Columns["MaxDiffHoriFL"].HeaderText = "Chênh lệch Trái/Phải đèn Sương mù tối đa";
