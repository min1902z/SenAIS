...
namespace SenAIS
{
    public partial class frmRearBrake : Form
    {
        ...
        private void UpdateBrakeValues(Dictionary<string, decimal> values)
        {
            ...
            decimal brakeEfficiency = minSumBrake != 0 ? (sumRearBrake * 0.5m / minSumBrake) * 100 : 0;

            if (brakeEfficiency >= 50 && brakeEfficiency <= 100 && sumRearBrake >= minSumBrake)
            {
            ...
            lbDiff_Brake.ForeColor = (maxDiffBrake == 0 || diffRearBrake <= maxDiffBrake) ? Color.Blue : Color.Red;
        }
        ...
        private void LoadVehicleStandards(string serialNumber)
        {
            ...
            if (vehicle != null)
            {
                ...
                if (standard != null)
                {
                    minSumBrake = standard.MinRearBrake ?? 0;
                    maxDiffBrake = standard.MaxDiffRearBrake ?? 0;
                }
            }
        ...
        {
            inspectionRepo.SaveRearBrakeData(this.serialNumber, this.rearLeftBrake, this.rearRightBrake);
        }
