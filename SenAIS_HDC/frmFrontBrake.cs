    ...
    public partial class frmFrontBrake : Form
    {
        ...
        private void LoadVehicleStandards(string serialNumber)
        {
            ...
            if (vehicle != null)
            {
                ...
                if (standard != null)
                {
                    minSumBrake = standard.MinFrontBrake ?? 0;
                    maxDiffBrake = standard.MaxDiffFrontBrake ?? 0;
                }
            }
        ...
        {
            inspectionRepo.SaveFrontBrakeData(this.serialNumber, this.frontLeftBrake, this.frontRightBrake);
        }
