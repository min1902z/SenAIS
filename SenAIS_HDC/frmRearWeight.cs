...
namespace SenAIS
{
    public partial class frmRearWeight : Form
    {
        ...
        private static readonly string opcWeightCounter = ConfigurationManager.AppSettings["WeightR_Counter"];
        private static readonly string opcLWeightResult = ConfigurationManager.AppSettings["Rear_LWeight_Result"];
        private static readonly string opcRWeightResult = ConfigurationManager.AppSettings["Rear_RWeight_Result"];
                ...
                Invoke((Action)(() =>
                {
                    switch (checkStatus)
                    {
                        ...
                        case 2: // Bắt đầu đo
                            ...
                            double rightWeightResult = opcManager.GetOPCValue(opcRWeightResult);
                        ...
                        case 4: // Xe tiếp theo
                            cbReady.BackColor = SystemColors.Control;
                            lbWeightTitle.Visible = false;
                            var formSS = new frmSideSlip(this.serialNumber);
                            formSS.Show();
                            this.Close();
                            break;
        ...
        private void frmRearWeight_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (updateTimer != null)
            {
